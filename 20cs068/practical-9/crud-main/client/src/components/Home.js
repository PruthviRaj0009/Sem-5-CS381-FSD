    ...
    return (
        ...
        <>
            ...
            <div className="mt-4">
                ...
                <h3 style={{fontWeight:"bold", color:"orange"}}>Employee List</h3>
                    <div className="add_btn mt-2 mb-2">
                        <NavLink to="/register" className="btn btn-primary" style={{backgroundColor:"#F8C471"}}>Add Employee</NavLink>
                        <Button style={{margin:"3px"}} onClick={userlogout}>LogOut</Button>
                    </div>
                    ...
                    <table class="table">
                        ...
                        <tbody style={{backgroundColor:"#F8C471", borderRadius:"9px"}}>
